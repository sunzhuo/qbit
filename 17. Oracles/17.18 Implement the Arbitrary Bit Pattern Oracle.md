# Implement the Arbitrary Bit Pattern Oracle
...
The effect of this oracle perfectly matches the action of the library operation `ApplyControlledOnBitString` that 
